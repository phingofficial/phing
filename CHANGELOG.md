 ...
 * Fixed FatalError in ZendGuardFileSet [\#854](https://api.github.com/repos/phingofficial/phing/issues/854)
 * Optimized api build file [\#852](https://api.github.com/repos/phingofficial/phing/issues/852)
 * Fixed grammar for phpdoc2 task. [\#851](https://api.github.com/repos/phingofficial/phing/issues/851)
 * Removed more include statements [\#850](https://api.github.com/repos/phingofficial/phing/issues/850)
 * Removed includes/requires from test sources. [\#849](https://api.github.com/repos/phingofficial/phing/issues/849)
 * Removed unused ident [\#846](https://api.github.com/repos/phingofficial/phing/issues/846)
 * Added SvnProp* tasks [\#845](https://api.github.com/repos/phingofficial/phing/issues/845)
 * Updated supported php version [\#844](https://api.github.com/repos/phingofficial/phing/issues/844)
 * Added ClasspathAware trait. [\#843](https://api.github.com/repos/phingofficial/phing/issues/843)
 * Get rid of FunctionParam class. [\#842](https://api.github.com/repos/phingofficial/phing/issues/842)
 * Added selectors to the grammar file. [\#841](https://api.github.com/repos/phingofficial/phing/issues/841)
 * Removed hhvm build from travis - added php nightly [\#839](https://api.github.com/repos/phingofficial/phing/issues/839)
 * Removed unused methods. [\#838](https://api.github.com/repos/phingofficial/phing/issues/838)
 * Fixed method call on duplicated targets. [\#837](https://api.github.com/repos/phingofficial/phing/issues/837)
 * Removed includes for phing own classes [\#836](https://api.github.com/repos/phingofficial/phing/issues/836)
 * Removed IterableFileSet [\#835](https://api.github.com/repos/phingofficial/phing/issues/835)
 * Removed settings of deprecated ini options [\#834](https://api.github.com/repos/phingofficial/phing/issues/834)
 * Simplified Character::isLetter() [\#833](https://api.github.com/repos/phingofficial/phing/issues/833)
 * Made DateSelector::setMillis() public [\#832](https://api.github.com/repos/phingofficial/phing/issues/832)
 * Improved error/exception reporting in Task::perform() [\#831](https://api.github.com/repos/phingofficial/phing/issues/831)
 * Added public setter/getter to reference object. [\#830](https://api.github.com/repos/phingofficial/phing/issues/830)
 * Target attrib of PhingTask must not be empty. [\#827](https://api.github.com/repos/phingofficial/phing/issues/827)
 * Included Listener/Logger chapter in master.xml [\#822](https://api.github.com/repos/phingofficial/phing/issues/822)
 * Updated documentation - FileSyncTask [\#820](https://api.github.com/repos/phingofficial/phing/issues/820)
 * Fixed call to a private member var. [\#819](https://api.github.com/repos/phingofficial/phing/issues/819)
 * Fixed exclude/include groups for phpunit 6. [\#818](https://api.github.com/repos/phingofficial/phing/issues/818)
 * Git branch [\#817](https://api.github.com/repos/phingofficial/phing/issues/817)
 * GitBranchTask failes with git >= 2.15.0 [\#816](https://api.github.com/repos/phingofficial/phing/issues/816)
 * Fixed composer install issue [\#815](https://api.github.com/repos/phingofficial/phing/issues/815)
 * Bump minimum PHP version to 7.0+ [\#813](https://api.github.com/repos/phingofficial/phing/issues/813)
 * PharPackageTask wrong format of path in webstub and/or clistub when building on Windows [\#809](https://api.github.com/repos/phingofficial/phing/issues/809)
 * Cannot make work PHPUnit 6 [\#802](https://api.github.com/repos/phingofficial/phing/issues/802)
 * Can't install dev-master version using Composer [\#799](https://api.github.com/repos/phingofficial/phing/issues/799)
 * Fixed generation of html reportfiles. [\#798](https://api.github.com/repos/phingofficial/phing/issues/798)
 * Init feature [\#796](https://api.github.com/repos/phingofficial/phing/issues/796)
 * Added type aware traits. [\#783](https://api.github.com/repos/phingofficial/phing/issues/783)
 * Added regex attrib to the filename selector. [\#782](https://api.github.com/repos/phingofficial/phing/issues/782)
 * Added casesensitive and handledirsep attribs to the regexp mapper. [\#781](https://api.github.com/repos/phingofficial/phing/issues/781)
 * Added casesensitive and handledirsep attribs to the glob mapper. [\#780](https://api.github.com/repos/phingofficial/phing/issues/780)
 * Added multline attribute to containsregexp selector. [\#779](https://api.github.com/repos/phingofficial/phing/issues/779)
 * Added negate, regexp, casesensitive attribs to linecontainsregexp filter [\#778](https://api.github.com/repos/phingofficial/phing/issues/778)
 * Added negate attribute to the `linecontains` filter. [\#777](https://api.github.com/repos/phingofficial/phing/issues/777)
 * Fixed log method - HttpGetTask. [\#771](https://api.github.com/repos/phingofficial/phing/issues/771)
 * Added stopwatch name to log output. [\#767](https://api.github.com/repos/phingofficial/phing/issues/767)
 * feature request: stopwatch should show name as well  [\#765](https://api.github.com/repos/phingofficial/phing/issues/765)
 * stopwatch includes autoloader [\#764](https://api.github.com/repos/phingofficial/phing/issues/764)
 * Fix: php.ini variable evaluation and "Notice: A non well formed numeric value encountered" [\#761](https://api.github.com/repos/phingofficial/phing/issues/761)
 * Added ability logging exceptions. [\#760](https://api.github.com/repos/phingofficial/phing/issues/760)
 * Added location setting to all task defined. [\#759](https://api.github.com/repos/phingofficial/phing/issues/759)
 * Added DependSet task. [\#757](https://api.github.com/repos/phingofficial/phing/issues/757)
 * Added FileList support to the TouchTask [\#756](https://api.github.com/repos/phingofficial/phing/issues/756)
 * Added osfamily attribute to ExecTask [\#755](https://api.github.com/repos/phingofficial/phing/issues/755)
 * Fixed usage of filelist if PathConvert uses a reference. [\#754](https://api.github.com/repos/phingofficial/phing/issues/754)
 * Superseded #302 Remove S3 PEAR dependency [\#748](https://api.github.com/repos/phingofficial/phing/issues/748)
 * Added relentless task. [\#746](https://api.github.com/repos/phingofficial/phing/issues/746)
 * StatisticsListener [\#744](https://api.github.com/repos/phingofficial/phing/issues/744)
 * Default exclude task [\#740](https://api.github.com/repos/phingofficial/phing/issues/740)
 * Fixed PropertyConditions behavior. [\#739](https://api.github.com/repos/phingofficial/phing/issues/739)
 * Fixed deprecated function calls. [\#737](https://api.github.com/repos/phingofficial/phing/issues/737)
 * SCA with Php Inspections (EA Extended) [\#731](https://api.github.com/repos/phingofficial/phing/issues/731)
 * Added PHPLoc ^4 support. [\#729](https://api.github.com/repos/phingofficial/phing/issues/729)
 * PHPLoc Task: Wrong class name in CSV Formatter [\#725](https://api.github.com/repos/phingofficial/phing/issues/725)
 * PHPLoc task Wrong class name for XML Logger class [\#724](https://api.github.com/repos/phingofficial/phing/issues/724)
 ...
 * symfony/yaml dependency improvemnt [\#658](https://api.github.com/repos/phingofficial/phing/issues/658)
 * Deprecate the PEAR channel [\#657](https://api.github.com/repos/phingofficial/phing/issues/657)
 * Making phing compatible with phive (https://phar.io) [\#633](https://api.github.com/repos/phingofficial/phing/issues/633)
 * Phing Strict Build Mode [\#626](https://api.github.com/repos/phingofficial/phing/issues/626)
 * Adding 0 and 1 strings as true and false values in StringHelper. [\#590](https://api.github.com/repos/phingofficial/phing/issues/590)
 * PHPUnitReportTask fails with XSLTProcessor::importStylesheet() unable to read phar:/usr/local/bin/phing/etc/str.replace.function.xsl (Trac #1240) [\#584](https://api.github.com/repos/phingofficial/phing/issues/584)
 * Unit test for various Git and SVN related tasks fails if locale is not 'en' or 'C' (Trac #1213) [\#577](https://api.github.com/repos/phingofficial/phing/issues/577)
 * Phingcall should have the options returnProperty (Trac #1209) [\#576](https://api.github.com/repos/phingofficial/phing/issues/576)
 ...
 * includePath using project.basedir is failing under certain conditions (Trac #586) [\#537](https://api.github.com/repos/phingofficial/phing/issues/537)
 * Properties not being set on subsequent sets. (Trac #511) [\#535](https://api.github.com/repos/phingofficial/phing/issues/535)
 * Build Progress Bar (Trac #305) [\#532](https://api.github.com/repos/phingofficial/phing/issues/532)
 * Document that in a FileSet include/exclude "foo/" means "foo/**" [\#367](https://api.github.com/repos/phingofficial/phing/issues/367)
 * Make basedir property (including its default value) a path relative to the buildfile [\#358](https://api.github.com/repos/phingofficial/phing/issues/358)
 * Remove S3 PEAR dependency [\#302](https://api.github.com/repos/phingofficial/phing/issues/302)
 * Consider the strings "1" and "0" to be true and false, respectively. [\#261](https://api.github.com/repos/phingofficial/phing/issues/261)
 * Phing Strict Build Mode [\#159](https://api.github.com/repos/phingofficial/phing/issues/159)
 ...
 * Optimized api build file [\#852](https://api.github.com/repos/phingofficial/phing/pulls/852)
 * Fixed grammar for phpdoc2 task. [\#851](https://api.github.com/repos/phingofficial/phing/pulls/851)
 * Removed more include statements [\#850](https://api.github.com/repos/phingofficial/phing/pulls/850)
 * Removed includes/requires from test sources. [\#849](https://api.github.com/repos/phingofficial/phing/pulls/849)
 * Removed unused ident [\#846](https://api.github.com/repos/phingofficial/phing/pulls/846)
 * Added SvnProp* tasks [\#845](https://api.github.com/repos/phingofficial/phing/pulls/845)
 * Updated supported php version [\#844](https://api.github.com/repos/phingofficial/phing/pulls/844)
 * Added ClasspathAware trait. [\#843](https://api.github.com/repos/phingofficial/phing/pulls/843)
 * Get rid of FunctionParam class. [\#842](https://api.github.com/repos/phingofficial/phing/pulls/842)
 * Added selectors to the grammar file. [\#841](https://api.github.com/repos/phingofficial/phing/pulls/841)
 * Removed hhvm build from travis - added php nightly [\#839](https://api.github.com/repos/phingofficial/phing/pulls/839)
 * Removed unused methods. [\#838](https://api.github.com/repos/phingofficial/phing/pulls/838)
 * Fixed method call on duplicated targets. [\#837](https://api.github.com/repos/phingofficial/phing/pulls/837)
 * Removed includes for phing own classes [\#836](https://api.github.com/repos/phingofficial/phing/pulls/836)
 * Removed IterableFileSet [\#835](https://api.github.com/repos/phingofficial/phing/pulls/835)
 * Removed settings of deprecated ini options [\#834](https://api.github.com/repos/phingofficial/phing/pulls/834)
 * Simplified Character::isLetter() [\#833](https://api.github.com/repos/phingofficial/phing/pulls/833)
 * Made DateSelector::setMillis() public [\#832](https://api.github.com/repos/phingofficial/phing/pulls/832)
 * Improved error/exception reporting in Task::perform() [\#831](https://api.github.com/repos/phingofficial/phing/pulls/831)
 * Added public setter/getter to reference object. [\#830](https://api.github.com/repos/phingofficial/phing/pulls/830)
 * Target attrib of PhingTask must not be empty. [\#827](https://api.github.com/repos/phingofficial/phing/pulls/827)
 * Included Listener/Logger chapter in master.xml [\#822](https://api.github.com/repos/phingofficial/phing/pulls/822)
 * Updated documentation - FileSyncTask [\#820](https://api.github.com/repos/phingofficial/phing/pulls/820)
 * Fixed call to a private member var. [\#819](https://api.github.com/repos/phingofficial/phing/pulls/819)
 * Fixed exclude/include groups for phpunit 6. [\#818](https://api.github.com/repos/phingofficial/phing/pulls/818)
 * Git branch [\#817](https://api.github.com/repos/phingofficial/phing/pulls/817)
 * Fixed composer install issue [\#815](https://api.github.com/repos/phingofficial/phing/pulls/815)
 * Fixed generation of html reportfiles. [\#798](https://api.github.com/repos/phingofficial/phing/pulls/798)
 * Added type aware traits. [\#783](https://api.github.com/repos/phingofficial/phing/pulls/783)
 * Added regex attrib to the filename selector. [\#782](https://api.github.com/repos/phingofficial/phing/pulls/782)
 * Added casesensitive and handledirsep attribs to the regexp mapper. [\#781](https://api.github.com/repos/phingofficial/phing/pulls/781)
 * Added casesensitive and handledirsep attribs to the glob mapper. [\#780](https://api.github.com/repos/phingofficial/phing/pulls/780)
 * Added multline attribute to containsregexp selector. [\#779](https://api.github.com/repos/phingofficial/phing/pulls/779)
 * Added negate, regexp, casesensitive attribs to linecontainsregexp filter [\#778](https://api.github.com/repos/phingofficial/phing/pulls/778)
 * Added negate attribute to the `linecontains` filter. [\#777](https://api.github.com/repos/phingofficial/phing/pulls/777)
 * Fixed log method - HttpGetTask. [\#771](https://api.github.com/repos/phingofficial/phing/pulls/771)
 * Added stopwatch name to log output. [\#767](https://api.github.com/repos/phingofficial/phing/pulls/767)
 * Fix: php.ini variable evaluation and "Notice: A non well formed numeric value encountered" [\#761](https://api.github.com/repos/phingofficial/phing/pulls/761)
 * Added ability logging exceptions. [\#760](https://api.github.com/repos/phingofficial/phing/pulls/760)
 * Added DependSet task. [\#757](https://api.github.com/repos/phingofficial/phing/pulls/757)
 * Added FileList support to the TouchTask [\#756](https://api.github.com/repos/phingofficial/phing/pulls/756)
 * Added osfamily attribute to ExecTask [\#755](https://api.github.com/repos/phingofficial/phing/pulls/755)
 * Fixed usage of filelist if PathConvert uses a reference. [\#754](https://api.github.com/repos/phingofficial/phing/pulls/754)
 * Superseded #302 Remove S3 PEAR dependency [\#748](https://api.github.com/repos/phingofficial/phing/pulls/748)
 * Added relentless task. [\#746](https://api.github.com/repos/phingofficial/phing/pulls/746)
 * StatisticsListener [\#744](https://api.github.com/repos/phingofficial/phing/pulls/744)
 * Default exclude task [\#740](https://api.github.com/repos/phingofficial/phing/pulls/740)
 * Fixed PropertyConditions behavior. [\#739](https://api.github.com/repos/phingofficial/phing/pulls/739)
 ...
 * Make basedir property (including its default value) a path relative to the buildfile [\#358](https://api.github.com/repos/phingofficial/phing/pulls/358)
